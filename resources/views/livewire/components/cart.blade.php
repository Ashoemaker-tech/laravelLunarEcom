<div class="sm:relative"
    ...
    <button class="relative text-center text-gray-700 transition hover:text-primary"
            x-on:click="linesVisible = !linesVisible">
        <div class="text-2xl">
            <i class="fa-solid fa-bag-shopping"></i>
        </div>
        <div class="text-xs leading-3">Cart</div>
        <div class="absolute flex items-center justify-center w-5 h-5 text-xs text-white rounded-full -right-3 -top-1 bg-primary">
        2</div>
    </button>
